...
router.get('/users', function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users, error_1;
...
router.patch('/updateUser/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, User_1["default"].findByIdAndUpdate(req.params.id, req.body, {
                        "new": true
                    })];
            case 1:
                user = _a.sent();
